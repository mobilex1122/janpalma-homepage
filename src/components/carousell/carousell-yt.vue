...
defineProps<{ width?:string, video:string ,title:string}>()
...
<template>
    ...
    <div class="carousel-item w-100 bg-white position-relative">
        <div style="isolation: isolate;">
            ...
            <b class="d-md-block d-none position-absolute text-white text-center bottom-0 start-0 w-100 pb-2" style="filter: drop-shadow(black 0 0px 4px);">{{ title }}</b>
        ...
        <div class="modal modal-xl fade" :id=video tabindex="-1" :aria-labelledby=title aria-hidden="true">
